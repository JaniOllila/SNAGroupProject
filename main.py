...
"""
    ...
    Here at beginning adding tables that contain weather station coordinataes to be used to calculate turbine
    distances to them as wind dataset did not contain any.
    All of the plots can be found in plots and figures folder
"""
stations = {
    "Hailuoto":(65, 24.7),
    "Kokkola":(63.8, 23.1),
...
#-----------------Task 1-2-----------------------------------
#read and filter powerplant data to be used later
...
#print(df_all_wind.info())
df_all_wind.describe().to_csv("info_of_wind.csv")
...
#-----------------Task 5-----------------------------------
# Calculatin summary statitics for each turbine and making on dataframe of 
# the data also scaling the data using standarscaler
...
#-----------------Task 6-----------------------------------
#risk score calculations using logistig regression model
...
# Creates network by conecting nodes based on distance treshold
...
#-----------------Task 8-----------------------------------
#created similarity matrix and assing weight to each edge with some simple expontial function discounting distance score
...
#-----------------Task 10-----------------------------------
# Identifying critical nodes in network based on nodes centrality measures
...
#-----------------Task 11-----------------------------------
# wind trends vs risk score calculating and grouping data for some period and plotting it and risk score changes
...
plt.legend()
plt.title("Risk score Trends during year")
plt.xlabel("days")
plt.ylabel("score")
plt.xticks(rotation=45)
plt.tight_layout()
